"""
Django settings for the Communication Service.
"""
import os
...
DATABASES = {
    "default": dj_database_url.parse(
        os.environ.get(
            "DATABASE_URL",
            "postgres://learnsphere:learnsphere@postgres:5432/communication_db",
        )
    )
}
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "communication.jwt_auth.StatelessJWTAuthentication",
    ],
    "DEFAULT_PERMISSION_CLASSES": [],
    "UNAUTHENTICATED_USER": None,
    "DEFAULT_PAGINATION_CLASS": "rest_framework.pagination.LimitOffsetPagination",
    "PAGE_SIZE": 20,
    "EXCEPTION_HANDLER": "communication.exceptions.friendly_exception_handler",
}
...
DEFAULT_FROM_EMAIL = os.environ.get("NOTIFICATIONS_FROM", "notifications@learnsphere.dev")
